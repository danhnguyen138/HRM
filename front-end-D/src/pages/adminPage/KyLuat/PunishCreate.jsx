...
const createPunishSchema = yup.object().shape({
    ...
    moneyPunish: yup.string().matches(/^[0-9]*$/, 'Xin nhập chữ số').required('Xin nhập tiền thưởng'),
                                    ...
                                    return (
                                        <form className='bg-white w-full shadow-md p-3 rounded' onSubmit={handleSubmit}>
                                            ...
                                            <div className='grid grid-cols-1 mb-6'>
                                                <label className="block text-gray-700 font-bold mb-2" htmlFor='contentPunish'>
                                                    Nội dung
                                                </label>
                                                {errors.contentPunish && touched.contentPunish ? (<div className='text-sm text-red-700 mb-1'>{errors.contentPunish}</div>) :
