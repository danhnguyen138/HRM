...
app.use('/api/user/contract/:id', hopdongRoutes, hopdongController.getHopDongByIdNhanVien);
app.use('/api/user/insurance/:id', insuranceRoutes, insuranceController.getInsuranceDetail);
...
app.use('/api/user/phancongnhanvien', phancongRoutes, phancongController.CreatePhanCong);
...
app.use('/api/user/xoaphancong/:ngayPhanCong/:value', phancongRoutes, phancongController.deleteCongViec);
app.use('/api/user/danhgianhanvien/:ngayPhanCong/:value', phancongRoutes, phancongController.danhgiaCongViec);
